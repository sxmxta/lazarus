...
const laz = __importStar(require("./Lazarus"));
const pkgs = __importStar(require("./Packages"));
const RepoBaseURL = 'https://packages.lazarus-ide.org';
const ParamJSON = 'packagelist.json';
class Installer {
    constructor(LazarusVerzion, PackageList, WithCache, OsArch) {
        this._Lazarus = new laz.Lazarus(LazarusVerzion, WithCache, OsArch);
